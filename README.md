...
中文的人体器官 3D 图鉴：浏览 104 个器官与解剖结构的介绍，旋转、剖切、分层查看
...
- 将界面与内容收敛为中文人体器官 3D 图鉴，并把内容扩展到 104 个器官与解剖结构；
...
- 104 个器官与解剖结构的中文档案：描述、大小/重量/位置/功能/血供、医学意义、趣味知识
- 从 Human Atlas 的 BodyParts3D 数据新增 25 个主题（227 个源网格），附真实模型预览与可复现导入清单；
...
`npm test` 会先构建站点，再检查 104 个内容条目的模型、插图和来源文档是否完整。
...
| [Open3DModel / AnatomyTOOL](https://anatomytool.org/open3dmodel-create) | 骨骼、颅骨、脊柱、典型椎骨、手与腕、肩/肘/髋关节、踝与足、旋转袖、臂丛神经、正中/尺/桡/腋/肌皮神经、前臂屈肌群、上肢带肌群、彩色颅底、分解颅骨、股管 | CC BY-SA（以源项目标注为准） |
| [Z-Anatomy](https://github.com/LluisV/Z-Anatomy) | 全身主要肌群、脑神经、甲状腺、甲状旁腺、睾丸与附睾、唾液腺、咽、颞下颌关节、椎间盘、淋巴系统概览、恒牙、鼻（鼻骨与鼻软骨）、听小骨 | CC BY-SA 4.0；源项目中的混合资产需逐项核对 |
