...
中文的人体器官 3D 图鉴：浏览 79 个器官与解剖结构的介绍，旋转、剖切、分层查看
...
- 将界面与内容收敛为中文人体器官 3D 图鉴，并把内容扩展到 79 个器官与解剖结构；
...
- 79 个器官与解剖结构的中文档案：描述、大小/重量/位置/功能/血供、医学意义、趣味知识
...
`npm test` 会先构建站点，再检查 79 个内容条目的模型、插图和来源文档是否完整。
